...
function preload(){
batman_Walking = loadAnimation("images/walking_1.png","images/walking_2.png","images/walking_3.png","images/walking_4.png","images/walking_5.png","images/walking_6.png","images/walking_7.png","images/walking_8.png");
...
function setup(){
    ...
    bruceWayne.addAnimation("batman",batman_Walking)
    bruceWayne.scale = 0.4

    thunderBolt = createSprite(200,90)

    for(var i=0;i<maxDrops;i++){
        rainDrop.push(new Drop(random(0,400),random(0,400),5))
    }
    Engine.run(engine)
